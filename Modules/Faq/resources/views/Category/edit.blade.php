    ...
    <div class="main-content">
        <section class="section">
            ...
            <x-admin.breadcrumb title="{{ __('Edit Category') }}" :list="[
                ...
                __('Category List') => route('admin.faq-category.index'),
                __('Edit Category') => '#',
            ]" />
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header gap-3 justify-content-between align-items-center">
                            ...
                            @adminCan('faq.category.translate')
                                ...
                                <ul class="lang_list">
                                    @foreach ($languages as $language)
                                        <li><a id="{{ request('code') == $language->code ? 'selected-language' : '' }}"
                                                href="{{ route('admin.faq-category.edit', ['faq_category' => $category->id, 'code' => $language->code]) }}"><i
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div>
                                    <x-admin.back-button :href="route('admin.faq-category.index')" />
                                </div>
                            </div>
                            <div class="card-body">
                                <form
                                    action="{{ route('admin.faq-category.update', ['faq_category' => $category->id, 'code' => $code]) }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
