...
@section('admin-content')
    <div class="main-content">
        <section class="section">
            {{-- Breadcrumb --}}
            <x-admin.breadcrumb title="{{ __('Departments') }}" :list="[
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div>
                                    <x-admin.add-button :href="route('admin.department.create')" />
                                </div>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input onchange="changeStatus({{ $department->id }})"
                                                            ...
                                                            {{ $department->status ? 'checked' : '' }} data-toggle="toggle"
                                                    ...
                                                    <td>
                                                        ...
                                                        @if (checkAdminHasPermission('department.delete') && $department?->lawyers->count() == 0)
                                                            <x-admin.delete-button :id="$department->id"
                                                                onclick="deleteData" />
                                                        @endif
                                                    </td>
                                                </tr>
                                            @empty
                                                <x-empty-table :name="__('Department')" route="admin.department.create"
    ...
    <script>
        ...
        function changeStatus(id) {
            ...
            $.ajax({
                ...
                url: "{{ url('/admin/department/status-update') }}" + "/" + id,
