    ...
    <div class="main-content">
        <section class="section">
            <x-admin.breadcrumb title="{{ __('FAQS') }}" :list="[
                ...
                __('Edit Department') => route('admin.department.edit', [
                            ...
                            <ul class="lang_list">
                                @foreach ($languages as $language)
                                    <li><a id="{{ request('code') == $language->code ? 'selected-language' : '' }}"
                                            href="{{ route('admin.faq.by.department', ['slug' => $department->slug, 'code' => $language->code]) }}"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="{{ route('admin.department-faq.store') }}" method="POST">
                            @csrf
                            <x-admin.form-input type="hidden" id="department_id" name="department_id"
                                value="{{ $department->id }}" />
        ...
        <div class="modal fade" id="edit_faq_id_{{ $faq->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="{{ route('admin.department-faq.update', ['department_faq' => $faq->id, 'code' => $code]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <x-admin.form-input type="hidden" id="department_id" name="department_id"
...
@push('js')
    <script>
        ...
        function deleteData(id) {
            $("#deleteForm").attr("action", "{{ url('/admin/department-faq/') }}" + "/" + id)
        }
        ...
        function changeStatus(id) {
            ...
            $.ajax({
                ...
                url: "{{ url('/admin/department-faq/status-update') }}" + "/" + id,
