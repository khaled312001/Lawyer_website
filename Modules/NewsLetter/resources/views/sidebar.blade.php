<li
    class="nav-item dropdown {{ isRoute('admin.subscriber-list') || isRoute('admin.subscriber-content') || isRoute('admin.send-mail-to-newsletter') ? 'active' : '' }}">
    ...
    <ul class="dropdown-menu">
        ...
        @endadminCan
        @adminCan('newsletter.content.view')
        <li class="{{ isRoute('admin.subscriber-content') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.subscriber-content', ['code' => getSessionLanguage()]) }}">
