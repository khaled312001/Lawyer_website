...
@section('title')
    <title>{{ __('Banned Clients') }}</title>
@endsection
@section('admin-content')
    <div class="main-content">
        <section class="section">
            <x-admin.breadcrumb title="{{ __('Banned Client') }}" :list="[
                                ...
                                <form action="{{ route('admin.banned-customers') }}" method="GET"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group mb-3 mb-md-0">
                                            <x-admin.form-select name="verified" id="verified" class="form-select">
                                                <x-admin.select-option value="" text="{{ __('Select Verified') }}" />
                                                <x-admin.select-option :selected="request('verified') == '1'" value="1"
                                                    text="{{ __('Verified') }}" />
                                                <x-admin.select-option :selected="request('verified') == '0'" value="0"
