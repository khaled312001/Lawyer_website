...
class PaymentGatewayService extends PaymentMethodService {
    ...
    public function __construct(?PaymentMethodService $previousService = null) {
        ...
        $this->paymentSetting = $this->get_basic_payment_info();
        ...
        // For API
        self::additionalApiActiveGatewaysList([
            [
                'method' => self::RAZORPAY,
                'image'  => $this->paymentSetting->razorpay_image ?? 'uploads/website-images/razorpay.png',
                'status' => $this->paymentSetting->razorpay_status == $this->activeStatus ? 'active' : 'inactive',
            ],
            [
                'method' => self::FLUTTERWAVE,
                'image'  => $this->paymentSetting->flutterwave_image ?? 'uploads/website-images/flutterwave.png',
                'status' => $this->paymentSetting->flutterwave_status == $this->activeStatus ? 'active' : 'inactive',
            ],
            [
                'method' => self::PAYSTACK,
                'image'  => $this->paymentSetting->paystack_image ?? 'uploads/website-images/paystack.png',
                'status' => $this->paymentSetting->paystack_status == $this->activeStatus ? 'active' : 'inactive',
            ],
            [
                'method' => self::MOLLIE,
                'image'  => $this->paymentSetting->mollie_image ?? 'uploads/website-images/mollie.png',
                'status' => $this->paymentSetting->mollie_status == $this->activeStatus ? 'active' : 'inactive',
            ],
            [
                'method' => self::INSTAMOJO,
                'image'  => $this->paymentSetting->instamojo_image ?? 'uploads/website-images/instamojo.png',
                'status' => $this->paymentSetting->instamojo_status == $this->activeStatus ? 'active' : 'inactive',
            ],
        ]);
    }
    ...
    public function getGatewayDetails(string $gatewayName): ?object {
        $paymentSetting = $this->get_basic_payment_info();
