...
try {
    ...
    if (!$department || !$location) {
        throw new Exception('يجب وجود قسم وموقع واحد على الأقل في قاعدة البيانات');
    }
    ...
    echo "✓ المحامي تم إنشاؤه/تحديثه بنجاح (ID: {$lawyerId})\n";
    ...
    echo "✓ الترجمات تم إنشاؤها بنجاح\n";
    ...
    echo "✓ روابط وسائل التواصل الاجتماعي تم إنشاؤها بنجاح\n";

    DB::commit();

    echo "\n✅ تم إضافة/تحديث المحامي بنجاح!\n\n";
